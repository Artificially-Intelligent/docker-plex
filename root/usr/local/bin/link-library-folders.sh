...
if [ "${library_path_master}" = "${library_path_local}" ]; then
    echo "master and local library paths are identical. Skipping linkage plex library mount paths to master library paths"
else
